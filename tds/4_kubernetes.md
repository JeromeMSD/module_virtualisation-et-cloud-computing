...
> [!note]
> **Rappel** - L'image a déployer est `europe-west1-docker.pkg.dev/polytech-dijon/polytech-dijon/kuard:blue   ` qui répond au requête sur le port `8080` (et non `80` comme nginx)
